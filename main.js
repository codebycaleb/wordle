(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    function isSuggestedWord() {
      const urlParams = new URLSearchParams(window.location.search);
      return urlParams.get("suggested");
    }
    ...
    function randomWordLink() {
      ...
      return newCustomWordLink(randomWord());
    }
    function randomWord() {
      // return a random word from La
    ...
    function Da(e) {
      ...
      return customWord ? customWord : randomWord();
    }
    function Ga(e) {
      return Na(Ha, e);
    }
    ...
    Ka.innerHTML =
      "\n  <style>\n  .toaster {\n    position: absolute;\n    top: 10%;\n    left: 50%;\n    transform: translate(-50%, 0);\n    pointer-events: none;\n    width: fit-content;\n  }\n  #game-toaster {\n    z-index: "
        ...
        .concat(
          4e3,
          ';\n  }\n\n  #game {\n    width: 100%;\n    max-width: var(--game-max-width);\n    margin: 0 auto;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n  }\n  header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-1);\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n  header .title {\n    font-weight: 700;\n    font-size: 36px;\n    letter-spacing: 0.2rem;\n    text-transform: uppercase;\n    text-align: center;\n    position: absolute;\n    left: 0;\n    right: 0;\n    pointer-events: none;\n  }\n\n  @media (max-width: 360px) {\n    header .title {\n      font-size: 22px;\n      letter-spacing: 0.1rem;\n    }\n  }\n\n  #board-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-grow: 1;\n    overflow: hidden;\n  }\n  #board {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    grid-gap: 5px;\n    padding:10px;\n    box-sizing: border-box;\n  }\n  button.icon {\n    background: none;\n    border: none;\n    cursor: pointer;\n    padding: 0 4px;\n  }\n\n  #debug-tools {\n    position: absolute;\n    bottom: 0;\n  }\n\n  </style>\n  <game-theme-manager>\n    <div id="game">\n      <header>\n        <div class="menu">\n          <button id="help-button" class="icon" aria-label="help">\n            <game-icon icon="help"></game-icon>\n          </button>\n        </div>\n        <div class="title">\n         WORDLE\n        </div>\n        <div class="menu">\n          <button id="statistics-button" class="icon" aria-label="statistics">\n            <game-icon icon="statistics"></game-icon>\n          </button>\n          <button id="settings-button" class="icon" aria-label="settings">\n            <game-icon icon="settings"></game-icon>\n          </button>\n        </div>\n      </header>\n        <div id="board-container">\n          <div id="board"></div>\n        </div>\n        <div><style>  #suggestions {\n    margin: 0 8px;\n    user-select: none;\n  }\n  \n  #suggestions .row {\n    display: flex;\n    width: 100%;\n    margin: 0 auto 8px;\n    touch-action: manipulation;\n  }\n  \n  #suggestions .row button {\n    font-family: inherit;\n    font-weight: bold;\n    border: 2px dashed var(--color-present); ;\n    padding: 0;\n    margin: 0 6px 0 0;\n    height: 58px;\n    border-radius: 4px;\n    cursor: pointer;\n    user-select: none;\n    background-color: var(--key-bg);\n    color: var(--key-text-color);\n    flex: 1;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    text-transform: uppercase;\n    -webkit-tap-highlight-color: rgba(0,0,0,0.3);\n  }</style><div id="suggestions"></div></div>\n        <game-keyboard></game-keyboard>\n        <game-modal></game-modal>\n        <game-page></game-page>\n        <div class="toaster" id="game-toaster"></div>\n        <div class="toaster" id="system-toaster"></div>\n    </div>\n  </game-theme-manager>\n  <div id="debug-tools"></div>\n'
        );
    if (!isSuggestedWord()) {
      var suggestionRow = document.createElement("div");
      suggestionRow.classList.add("row");
      var suggestionRowInnerHTML = "";
      for (var words = 0; words < 3; words++) {
        var word = randomWord();
        var innerHTML = `<button 
        onclick="window.location.href='${newCustomWordLink(
          word
        )}&suggested=true';">${word}</button>`;
        suggestionRowInnerHTML += innerHTML;
      }
      var innerHTML = `<button onclick="window.location.href='${randomWordLink()}';">?</button>`;
      suggestionRowInnerHTML += innerHTML;
      suggestionRow.innerHTML = suggestionRowInnerHTML;
      Ka.content.querySelector("#suggestions").appendChild(suggestionRow);
    }
    var Qa = document.createElement("template");
    Qa.innerHTML =
